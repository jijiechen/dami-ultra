...
var configDiscardedPrompt = `generate a short sentence to tell a user that their configuration is discarded and the system won't be changed.`
var configValidatedPrompt = `generate a short compliment to the user that they've successfully written a valid configuration and ask them if they would like to apply it now`
